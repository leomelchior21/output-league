...
- Ten designed rounds: integers, strings, punctuation, six goals, escalating barriers, bumpers, opening pits, rotating arms, brief portal-rover steals, four moving goals in Orbit Mode, zero or a negative number, and a two-phase mastery sequence. Rovers disappear after a steal; the ball respawns at rest and cannot score until the player touches it again.
...
- From round five, a portal rover gives a visible warning, briefly steals nearby balls, then returns to its portal and disappears. Later rounds increase its speed and frequency. Amber repair pits open and close, gently ejecting cars or balls without an XP penalty. Neither distraction appears in the opening rounds.
- Wrong goals remove the points accumulated so far, reset the streak and vehicles, and preserve the challenge, output positions, round, and mastery phase.
