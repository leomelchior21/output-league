...
create table if not exists public.output_league_students (
...
create table if not exists public.student_sessions (
  ...
  student_id uuid not null references public.output_league_students(id) on delete cascade,
...
create table if not exists public.student_settings (
  student_id uuid primary key references public.output_league_students(id) on delete cascade,
...
alter table public.output_league_students enable row level security;
alter table public.student_sessions enable row level security;
alter table public.student_settings enable row level security;
alter table public.student_progress enable row level security;

revoke all on table public.output_league_students from anon, authenticated;
...
begin
  ...
  select grade into student_grade from public.output_league_students where id = student_id;
...
revoke all on function private.output_league_state(uuid, uuid) from public, anon, authenticated;
