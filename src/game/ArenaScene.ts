...
export interface Controls { x: number; y: number; boost: boolean; kick: boolean; kickRequested: boolean; paused: boolean; reducedMotion: boolean; settings?: Settings; skipIntro?: boolean }
