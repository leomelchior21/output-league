...
export const pythonLevels: Level[] = [
  ...
  { id: 2, title: 'SIMPLE VARIABLES', description: 'Store values in memory.', icon: 'box', locked: false, concept: 'score = 10' },
  { id: 3, title: 'RETRIEVING DATA', description: 'Read and update stored values.', icon: 'database', locked: false, concept: 'print(score)' },
  { id: 4, title: 'BASIC OPERATIONS', description: 'Work with numbers and values.', icon: 'calculator', locked: false, concept: '+ − × ÷' },
